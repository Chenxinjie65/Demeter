...
本文记录 V2 单例指数基金协议的正式架构决策。只有在用于解释当前产品或安全边界时才保留已否决方案。

---

## DEC-001 - 指数基金，而不是管理型 AMM
...
## DEC-004 - Chainlink 主锚 + 外部 DEX TWAP 保护
...
## DEC-006 - 第一阶段不强制 lock/callback 核心
...
## DEC-008 - AssetRegistry，而不是万能 AddressProvider
...
## DEC-012 - 公众使旧计划失效，Guardian 取消有效计划
...
## DEC-013 - 固定模块共享 Manager 操作 Guard
...
## DEC-014 - 取消仍保持 append-only 与首发 AUM 控制
